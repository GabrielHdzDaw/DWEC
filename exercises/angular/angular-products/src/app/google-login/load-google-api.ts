...
import { CLIENT_ID } from '../shared/google/google-login.config';
...
export class LoadGoogleApi {
  ...
  get credential$() {
    return this.#credential$.asObservable(); //Como readonly de signals, solo se recibe valor, no se puede modificar
  }
